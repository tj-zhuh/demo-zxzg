...
define(function (require) {
    ...
    ret.getGridData1 = function () {
        ...
        return [
            {
                Id: 11, aaaa: 'zbc', bbbb: '', cccc: '2017/6/20', dddd: 'XX仓库', eeee: 'Z-1153715', ffff: 'Y1234', gggg: '物料1', hhhh: 'T-676767', iiii: '3', jjjj: '10', kkkk: '2', llll: '工序1', mmmm: '1组', nnnn: '10', oooo: '设备1',
                ecolor: 'red', fcolor: 'red', gcolor: 'yellow', hcolor: 'green', icolor: 'red', jcolor: 'blue', kcolor: 'red', lcolor: 'red', mcolor: 'red'
            }, {
                Id: 11, aaaa: 'zbc', bbbb: '', cccc: '2017/6/20', dddd: 'XX仓库', eeee: 'Z-1123715', ffff: 'Z1234', gggg: '物料2', hhhh: 'T-676767', iiii: '5', jjjj: '20', kkkk: '3', llll: '工序2', mmmm: '2组', nnnn: '20', oooo: '设备2',
                ecolor: 'red', fcolor: 'red', gcolor: 'green', hcolor: 'green', icolor: 'green', jcolor: 'blue', kcolor: 'red', lcolor: 'blue', mcolor: 'red'
            }, {
                Id: 11, aaaa: 'zbc', bbbb: '', cccc: '2017/6/20', dddd: 'XX仓库', eeee: 'Z-1157615', ffff: 'X1234', gggg: '物料3', hhhh: 'T-676767', iiii: '7', jjjj: '30', kkkk: '4', llll: '工序3', mmmm: '3组', nnnn: '30', oooo: '设备3',
    ...
    ret.getGridData2 = function () {
        ...
        return [
            {
                Id: 11, aaaa: '1', bbbb: '设备1', cccc: '空闲', dddd: '机密', eeee: '增删改查', ffff: '增删改查', gggg: '增删改查', hhhh: '增删改查', iiii: '增删改查', jjjj: '增删改查', kkkk: '增删改查', llll: '增删改查', mmmm: '增删改查', nnnn: '增删改查', oooo: '增删改查',
                ecolor: 'red', fcolor: 'red', gcolor: 'yellow', hcolor: 'green', icolor: 'red', jcolor: 'blue', kcolor: 'red', lcolor: 'red', mcolor: 'red'
            }, {
                Id: 11, aaaa: '2', bbbb: '设备2', cccc: '空闲', dddd: '机密', eeee: '增删改查', ffff: '增删改查', gggg: '增删改查', hhhh: '增删改查', iiii: '增删改查', jjjj: '增删改查', kkkk: '增删改查', llll: '增删改查', mmmm: '增删改查', nnnn: '增删改查', oooo: '增删改查',
                ecolor: 'red', fcolor: 'red', gcolor: 'green', hcolor: 'green', icolor: 'green', jcolor: 'blue', kcolor: 'red', lcolor: 'blue', mcolor: 'red'
            }, {
                Id: 11, aaaa: '3', bbbb: '设备3', cccc: '空闲', dddd: '机密', eeee: '增删改查', ffff: '增删改查', gggg: '增删改查', hhhh: '增删改查', iiii: '增删改查', jjjj: '增删改查', kkkk: '增删改查', llll: '增删改查', mmmm: '增删改查', nnnn: '增删改查', oooo: '增删改查',
                ecolor: 'yellow', fcolor: 'yellow', gcolor: 'yellow', hcolor: 'yellow', icolor: 'red', jcolor: 'red', kcolor: 'red', lcolor: 'red', mcolor: 'red'
            }
            //, {
            //    Id: 11, aaaa: '', bbbb: '', cccc: '', dddd: '', eeee: '', ffff: '', gggg: '', hhhh: '', iiii: '', jjjj: '', kkkk: '', llll: '', mmmm: '', nnnn: '', oooo: '',
